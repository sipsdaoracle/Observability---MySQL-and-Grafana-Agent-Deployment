...
# pwsh scripts/retrieve-secrets.ps1 -Project $project -Secret 'sips-cicd-local' -Impersonate 'terraform-reader'

# pwsh scripts/retrieve-secrets.ps1 -Project $project -Secret 'sips-cicd-local'
...
minikube start --profile $profile  --memory=6000 --cpus=4
